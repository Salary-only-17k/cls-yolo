...
"""
python 01_cope_img2label.py --srcDir /media/cheng/data/02-data/cat_dog_dataset/train --resDir /media/cheng/data/02-data/cat_dog_dataset/dist
images\
        car\        imgs...
        bus\        imgs...
        truck\      imgs...
...
def parse_opt():
    ...
    # opts.label2index = {"dog":0,'cat':1,'c':2}   #! 需根据自己情况修改 
    opts.label2index = {"MVI_63525":0,'MVI_40191':1,'BITVehicle':2}   #! 需根据自己情况修改 
    show_lg('opts: ',opts)
    return opts
